...
def update_scoring_args(parser):
    ...
    parser.add_argument("-b", "--bias", type=str, help="[Deprecated in PyTorch backend; ignored] Bias model to use for variant scoring")
    parser.add_argument("-li", "--lite", action='store_true', help="[Deprecated in PyTorch backend; ignored] Models were trained with chrombpnet-lite")
