# Vendored from https://github.com/kundajelab/deeplift/blob/master/deeplift/dinuc_shuffle.py
# Copied verbatim except: .tostring() → .tobytes() (deprecated in NumPy >= 1.24)
